...
revoke all on function public.update_attendance_session(uuid, text, text, time, text) from public;
grant execute on function public.update_attendance_session(uuid, text, text, time, text) to authenticated;